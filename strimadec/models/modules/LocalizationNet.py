...
class LocalizationNet(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.register_buffer("prior_mu_transform", prior_mu_transform.view(1, OUTPUT_DIM))
        self.register_buffer("prior_var_transform", prior_var_transform.view(1, OUTPUT_DIM))
        return
