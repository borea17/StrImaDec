...
class VAE(nn.Module):
    ...
    Args:
        config (dict): dictionary containing the following configurations
            ...
            ################## OPTIONAL ARGS  ##################
            enforce_positivity (boolean): enforce that decoder output is positive (defaultly: False)
    Attributes:
    ...
    def __init__(self, config) -> None:
        ...
        if "enforce_positivity" in config:
            self.enforce_positivity = config["enforce_positivity"]
        else:
